        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">글 작성 페이지</h4>
                  <p class="card-description">
                    글 작성 페이지
                  </p>
                  <form name="wirteFrm" method="post" enctype="multipart/form-data" action="fileWrite.do"
                  	...
                  	<table>
                  	  <tbody>
                  		<tr>
	                        ...
	                        <input name="id" type="text" class="form-control" id="exampleInputEmail3" value="<%= session.getAttribute("id") %>" readonly/>
                  		  </td>
                  		</tr>  
                  	  </tbody>
                  	</table>
                      ...
                      <label>파일 첨부</label>
                      <input type="file" name="ofile" class="file-upload-default">
                      <div class="input-group col-xs-12">
                        <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                        <span class="input-group-append">
                          <button style="width:130px;" class="file-upload-browse btn btn-primary" type="button">Upload</button>
                        </span>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1"></label>
                      <textarea name="contents" class="form-control" id="exampleTextarea1" rows="10"></textarea>
                    </div>
                    <div style="display: flex; justify-content: space-between;">
	                   	<div>
	    	                <button type="reset" class="btn btn-light" position="right">Reset</button>
	                   	</div>
                    	<div>
